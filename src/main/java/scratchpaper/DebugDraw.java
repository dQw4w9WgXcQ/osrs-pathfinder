...
//import github.dqw4w9wgxcq.pathfinder.graphgeneration.GraphGenerationMain;
//
//import javax.swing.*;
//import java.awt.*;
//import java.io.File;
...
//            data = new CacheData(new File(GraphGenerationMain.DESKTOP_DIR, "cache"), new File(GraphGenerationMain.DESKTOP_DIR, "xteas.json"));
//        }
//
...
//            var region = data.getRegions().findRegionForRegionCoordinates(regionX, regionY);
//
//            for (var x = 0; x < 64; x++) {
//                for (var y = 0; y < 64; y++) {
